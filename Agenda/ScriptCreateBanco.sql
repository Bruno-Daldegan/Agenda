...
/****** Object:  Database [agenda]    Script Date: 13/01/2021 18:46:56 ******/
CREATE DATABASE [agenda]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'agenda', FILENAME = N'D:\Sql Server 2017\MSSQL14.MSSQLSERVER\MSSQL\DATA\agenda.mdf' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'agenda_log', FILENAME = N'D:\Sql Server 2017\MSSQL14.MSSQLSERVER\MSSQL\DATA\agenda_log.ldf' , SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
GO

ALTER DATABASE [agenda] SET COMPATIBILITY_LEVEL = 140
GO
